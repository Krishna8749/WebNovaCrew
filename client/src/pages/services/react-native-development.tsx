  ...
  return (
    <div className="min-h-screen bg-violet-950 font-sans">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "React Native Development", url: "https://xcflown.com/services/react-native-development" }
      ]} />
      <ServiceSchema 
        ...
        serviceUrl="https://xcflown.com/services/react-native-development"
      />
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-violet-200/80 mb-8 leading-relaxed">
              ...
              <strong className="text-orange-400"> JavaScript & React</strong>. Native components, code sharing, Meta-backed framework. 80+ apps delivered.
            </p>
      ...
      <section className="py-24 bg-violet-950">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Why Choose <span className="text-orange-400">React Native</span>?</h2>
          </div>
      ...
      <section className="py-24 bg-gradient-to-b from-slate-950 to-cyan-950/20">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">React Native <span className="text-orange-400">Pricing</span></h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricing.map((tier, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                className={`relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 border rounded-3xl p-8 ${tier.popular ? 'border-orange-500 scale-105' : 'border-white/10'}`}>
                ...
                <div className="mb-2"><span className="text-2xl font-bold text-orange-400">{tier.price}</span><span className="text-violet-200/60 ml-2">🇮🇳</span></div>
                ...
                <ul className="space-y-3 mb-8">
                  {tier.features.map((feature, j) => (
                    <li key={j} className="flex items-center gap-3 text-violet-200/80"><CheckCircle2 className="w-5 h-5 text-orange-400 shrink-0" />{feature}</li>
                  ))}
                </ul>
