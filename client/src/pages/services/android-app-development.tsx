  ...
  return (
    <div className="min-h-screen bg-violet-950 font-sans">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Android App Development", url: "https://xcflown.com/services/android-app-development" }
      ]} />
      <ServiceSchema 
        ...
        serviceUrl="https://xcflown.com/services/android-app-development"
      />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {androidFeatures.map((feature, index) => (
              <motion.div
                ...
                className="bg-violet-800/50 border border-violet-700 rounded-xl p-6 hover:border-green-500/50 transition-all"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 max-w-5xl mx-auto">
            {techStack.map((tech, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                transition={{ delay: index * 0.05 }}
                className="bg-violet-800/50 border border-violet-700 rounded-lg p-4 text-center hover:border-green-500/50 transition-all"
              >
