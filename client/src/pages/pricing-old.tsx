        ...
        <div className="container mx-auto max-w-6xl px-4 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-poppins font-bold text-slate-900 mb-6">
              Transparent <span className="text-violet-600">Pricing</span> for Every Budget
            </h1>
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              ...
              >
                <Card className={`h-full ${pkg.popular ? 'border-2 border-violet-600 shadow-xl relative' : 'border-slate-200'}`}>
                  {pkg.popular && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-violet-600 text-white text-sm font-bold px-4 py-1 rounded-full">
                      Most Popular
                    </div>
                  )}
                  ...
                  <CardContent>
                    ...
                    <Link href="/contact">
                      <Button className={`w-full ${pkg.popular ? 'bg-violet-600 hover:bg-violet-700' : 'bg-violet-900 hover:bg-violet-800'}`}>
                        {pkg.cta}
                      </Button>
                    </Link>
                  </CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <div className={`w-4 h-4 rounded border flex items-center justify-center ${
                            features.includes(feature.id) ? 'bg-violet-600 border-violet-600' : 'border-slate-300'
                          }`}>
            ...
            <div className="flex flex-col justify-center">
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-violet-900 text-white rounded-2xl p-8 text-center"
              >
                <p className="text-violet-200 mb-2">Estimated Project Cost</p>
                ...
                <div className="space-y-3 text-left mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-violet-200">Project Type</span>
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-violet-200">{projectType === "mobile" ? "Screens" : "Pages"}</span>
                    <span className="font-medium">{pages}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-violet-200">Features</span>
                    <span className="font-medium">{features.length} selected</span>
                  </div>
                </div>

                <Link href="/contact">
                  <Button size="lg" className="w-full bg-orange-500 text-violet-900 hover:bg-orange-400 font-bold">
              ...
              <p className="text-center text-slate-500 text-sm mt-6">
                Need a more accurate quote? <Link href="/contact" className="text-violet-600 hover:underline">Contact us</Link> for a free consultation.
              </p>
            </div>
          </div>
        </div>
