      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            {/* Agreement */}
            <div className="bg-violet-900/50 border border-violet-800 rounded-2xl p-8 mb-8">
              ...
              <p className="text-slate-400 leading-relaxed">
                These Terms of Service ("Terms") govern your access to and use of the XcFlown website located at xcflown.com (the "Service") operated by XcFlown ("us," "we," or "our").
              </p>
            ...
            <div className="bg-violet-900/50 border border-violet-800 rounded-2xl p-8 mb-8">
              ...
              <p className="text-slate-400 leading-relaxed">
                XcFlown provides custom web development, mobile app development, UI/UX design, and digital marketing services. Our services include but are not limited to:
              </p>
            ...
            <div className="bg-violet-900/50 border border-violet-800 rounded-2xl p-8 mb-8">
              ...
              <p className="text-slate-400 leading-relaxed">
                The Service and its original content (excluding content provided by users), features, and functionality are and will remain the exclusive property of XcFlown and its licensors. The Service is protected by copyright, trademark, and other laws of both India and foreign countries.
              </p>
              <p className="text-slate-400 leading-relaxed mt-4">
                Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of XcFlown. All other trademarks, product names, and logos appearing on the Service are the property of their respective owners.
              </p>
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">Client Work</h3>
              <p className="text-slate-400 leading-relaxed">
                Upon full payment for services rendered, clients receive ownership rights to the deliverables as specified in their individual service agreement. XcFlown retains the right to display completed work in our portfolio unless otherwise agreed in writing.
              </p>
            </div>
            ...
            <div className="bg-violet-900/50 border border-violet-800 rounded-2xl p-8 mb-8">
              ...
              <p className="text-slate-400 leading-relaxed">
                In no event shall XcFlown, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:
              </p>
              <ul className="text-slate-400 space-y-2 mt-4">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-orange-500 mt-2.5 shrink-0"></span>
            ...
            {/* Contact Us */}
            <div className="bg-gradient-to-r from-lime-500/10 to-emerald-500/10 border border-orange-500/20 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@xcflown.com" className="text-white hover:text-orange-400">info@xcflown.com</a>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-orange-500/10 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <a href="tel:+918360723410" className="text-white hover:text-orange-400">+91 83607 23410</a>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-orange-500/10 flex items-center justify-center">
