  ...
  const clientResults = [
    {
      ...
      quote: "XcFlown didn't just build us a dashboard—they built us a competitive advantage.",
  ...
  return (
    <div className="min-h-screen bg-white font-sans pt-20">
      <SEO 
        ...
        description="XcFlown is India's #1 custom web development and mobile app development company. We specialize in React, Next.js, Flutter, SEO, and e-commerce solutions. Get a free quote today!"
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          ...
          >
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2 py-2.5 px-5 rounded-full bg-gradient-to-r from-lime-500/20 to-emerald-500/20 text-orange-400 text-sm font-bold mb-8 border border-orange-500/30 backdrop-blur-sm"
            >
            ...
            <motion.p 
              ...
              className="text-2xl md:text-3xl text-violet-100/90 mb-10 max-w-4xl mx-auto leading-relaxed"
            >
            ...
            >
              <Link href="/contact">
                <Button size="lg" className="bg-orange-500 text-violet-900 hover:bg-orange-400 font-bold text-xl px-10 py-7 shadow-2xl shadow-lime-500/30 transition-all duration-300 hover:scale-105 hover:shadow-lime-500/50 rounded-full group">
            ...
            <motion.div 
              ...
              className="flex flex-wrap justify-center gap-6 text-violet-200/80 text-sm"
            >
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-orange-400" /> Free consultation</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-orange-400" /> No obligation</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-orange-400" /> Response within 24 hours</span>
            </motion.div>
          </motion.div>
        </div>
      </section>
                ...
                >
                  <div className="bg-white p-8 rounded-3xl border-2 border-red-100 hover:border-red-200 shadow-lg hover:shadow-xl transition-all group cursor-pointer h-full relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex items-start gap-6">
                      <div className="w-16 h-16 rounded-2xl bg-red-100 text-red-500 flex items-center justify-center shadow-lg group-hover:shadow-violet-500/50 group-hover:scale-110 transition-all duration-300">
                        {item.icon}
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-4">
                          <h3 className="font-bold text-2xl text-slate-900 group-hover:text-violet-600 transition-colors">{item.problem}</h3>
                          <ChevronRight className="w-6 h-6 text-violet-500 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                        </div>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-slate-50" id="services">
        <div className="container mx-auto max-w-6xl px-4">
          ...
          >
            <span className="inline-flex items-center gap-2 bg-violet-100 text-violet-700 px-5 py-2.5 rounded-full text-base font-bold mb-8">
              ...
              >
                <Link href={s.link}>
                  <div className="p-10 rounded-3xl bg-white hover:shadow-2xl shadow-lg border border-slate-100 transition-all duration-300 group cursor-pointer h-full relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex items-start gap-6">
                      <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 text-white flex items-center justify-center shrink-0 shadow-lg shadow-violet-500/30 group-hover:shadow-violet-500/50 group-hover:scale-110 transition-all duration-300">
                        {s.icon}
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-4">
                          <h3 className="font-bold text-2xl text-slate-900 group-hover:text-violet-600 transition-colors">{s.title}</h3>
                          <ChevronRight className="w-6 h-6 text-violet-500 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                        </div>
          ...
          >
            <Link href="/services">
              <Button className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-full px-10 py-6 shadow-xl shadow-violet-500/30 hover:shadow-violet-500/50 transition-all duration-300 hover:scale-105">
      ...
      <section className="py-28 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-violet-500/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="inline-flex items-center gap-2 bg-orange-500/20 text-orange-400 px-5 py-2.5 rounded-full text-base font-bold mb-8 border border-orange-500/30">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-poppins font-bold mb-8 leading-tight">
                Building Digital Excellence from <span className="text-orange-400">Lucknow to the World</span>
              </h2>
              <p className="text-violet-100 text-xl md:text-2xl mb-8 leading-relaxed">
                XcFlown was founded with a vision to provide world-class web development services from India. Our team of 25+ experts combines technical excellence with creative innovation to deliver solutions that drive real business results.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <a href="https://www.linkedin.com/company/web-Xc-Flown" target="_blank" className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-white/20 transition-colors">
                  <Linkedin className="w-5 h-5" /> LinkedIn
                </a>
                <a href="https://x.com/xcflown" target="_blank" className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-white/20 transition-colors">
                  <Twitter className="w-5 h-5" /> Twitter
                </a>
                <Link href="/contact">
                  <span className="flex items-center gap-2 bg-orange-500 text-slate-900 px-4 py-2 rounded-full hover:bg-orange-400 transition-colors font-bold cursor-pointer">
      ...
      <section id="case-studies" className="py-28 bg-violet-900 text-white px-4">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-20">
            <span className="text-orange-400 font-bold tracking-wider uppercase text-base mb-6 block">Proof, Not Promises</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
            {clientResults.map((client, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-violet-800 rounded-3xl p-10 border border-violet-700"
              >
                <div className="text-sm font-bold text-orange-400 uppercase tracking-wider mb-3">{client.industry}</div>
                <h3 className="text-2xl font-bold mb-5">{client.company}</h3>
                <div className="text-5xl font-bold text-orange-400 mb-5">{client.result}</div>
          ...
          <div className="text-center">
            <Link href="/portfolio">
              <Button size="lg" className="bg-orange-500 text-slate-900 hover:bg-orange-400 font-bold rounded-full px-10 py-7 text-lg">
      ...
      {/* Why Choose Us */}
      <section className="py-28 bg-violet-900 text-white px-4 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-violet-600 rounded-full blur-3xl opacity-20 translate-x-1/3 -translate-y-1/4"></div>
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-orange-500 rounded-full blur-3xl opacity-10 -translate-x-1/3 translate-y-1/3"></div>
        
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="font-poppins font-bold text-4xl md:text-5xl lg:text-6xl mb-8 leading-tight">
                Why leading brands choose <span className="text-orange-400">XcFlown</span>
              </h2>
              <p className="text-violet-100 text-xl md:text-2xl mb-12 leading-relaxed">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={i} className="flex items-center gap-5">
                    <div className="w-12 h-12 rounded-full bg-orange-400/20 flex items-center justify-center text-orange-400 shrink-0">
              ...
              <Link href="/about">
                 <Button className="mt-12 bg-white text-violet-900 hover:bg-violet-50 font-bold text-xl px-10 py-7 rounded-full">
                    More About Us
                 </Button>
              </Link>
            </div>
            ...
            <div className="relative">
               <div className="bg-white/10 backdrop-blur-md p-12 rounded-3xl border border-white/10 shadow-2xl">
                   <div className="flex items-center gap-5 mb-10">
                       <div className="w-18 h-18 bg-orange-400 rounded-2xl flex items-center justify-center shadow-lg p-4">
                           <Rocket className="w-10 h-10 text-violet-900" />
                       </div>
                       <div>
                           <div className="font-bold text-3xl">Start Your Project</div>
                           <div className="text-violet-200 text-lg">Get a proposal within 24 hours</div>
                       </div>
                   </div>
                   <p className="text-violet-100 mb-10 text-xl leading-relaxed">
                       "XcFlown transformed our online presence. We saw a 300% increase in leads within the first 3 months."
                   </p>
                   <div className="flex items-center gap-4">
                       <div className="w-14 h-14 bg-violet-500 rounded-full"></div>
                       <div>
                           <div className="font-bold text-xl">Rajesh Kumar</div>
                           <div className="text-base text-violet-300">CEO, TechFlow India</div>
                       </div>
                   </div>
               </div>
            </div>
        ...
        <div className="container mx-auto max-w-7xl px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-5">
            {technologies.map((tech) => (
              <span key={tech} className="px-8 py-4 bg-slate-100 rounded-full text-slate-700 font-semibold text-xl border border-slate-200 hover:bg-violet-50 hover:border-violet-200 hover:text-violet-700 transition-colors">
                {tech}
              </span>
            ))}
          </div>
      ...
      <section className="py-28 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto max-w-5xl px-4 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="inline-flex items-center gap-3 py-3 px-6 rounded-full bg-white/10 text-orange-400 text-base font-bold mb-8 border border-white/20">
            ...
            <p className="text-2xl md:text-3xl text-violet-100 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-10">
              <Link href="/contact">
                <Button size="lg" className="bg-orange-500 text-violet-900 hover:bg-orange-400 font-bold text-xl px-12 py-8 rounded-full shadow-xl">
            ...
            <div className="flex flex-wrap justify-center gap-8 text-lg text-violet-200">
              <span className="flex items-center gap-2"><BadgeCheck className="w-5 h-5 text-orange-400" /> Free consultation</span>
              <span className="flex items-center gap-2"><BadgeCheck className="w-5 h-5 text-orange-400" /> No obligation</span>
              <span className="flex items-center gap-2"><BadgeCheck className="w-5 h-5 text-orange-400" /> Response in 24 hours</span>
            </div>
          </motion.div>
        </div>
      </section>
