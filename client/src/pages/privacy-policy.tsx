      ...
      <section className="pt-32 pb-16 px-4 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">
            At XcFlown, we are committed to protecting your privacy and ensuring the security of your personal information.
          </p>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-violet-900/50 border border-violet-800 rounded-2xl p-8 mb-8">
              ...
              <p className="text-slate-400 leading-relaxed">
                XcFlown ("we," "our," or "us") operates the website xcflown.com (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.
              </p>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div className="bg-violet-900/50 border border-violet-800 rounded-2xl p-8 mb-8">
              ...
              <p className="text-slate-400 leading-relaxed mb-4">
                XcFlown uses the collected data for various purposes:
              </p>
            ...
            <div className="bg-violet-900/50 border border-violet-800 rounded-2xl p-8 mb-8">
              ...
              <p className="text-slate-400 leading-relaxed mt-4">
                Users may opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:text-orange-300">Google Ads Settings</a>. Alternatively, you can opt out of a third-party vendor's use of cookies for personalized advertising by visiting <a href="https://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:text-orange-300">www.aboutads.info</a>.
              </p>

              <h3 className="text-xl font-semibold text-white mt-8 mb-3">Google Analytics</h3>
              <p className="text-slate-400 leading-relaxed">
                We use Google Analytics to analyze the use of our website. Google Analytics gathers information about website use by means of cookies. The information gathered relating to our website is used to create reports about the use of our website. Google's privacy policy is available at: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:text-orange-300">https://policies.google.com/privacy</a>.
              </p>
