...
export default function WebDevelopmentIndiraNagar() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 font-sans">
      <SEO 
        title="Best Web Development Company in Indira Nagar, Lucknow | Web Nova Crew"
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Indira Nagar", url: "https://webnovacrew.com/locations/web-development-indira-nagar" }
      ]} />
      <ServiceSchema serviceName="Web Development in Indira Nagar" serviceDescription="Professional web and app development services in Indira Nagar, Lucknow. Education platforms, healthcare apps, business websites, and digital marketing." serviceUrl="https://webnovacrew.com/locations/web-development-indira-nagar" />
      <FAQSchema faqs={faqs} />
      <Navbar />
      ...
      <section className="py-20 bg-gradient-to-br from-rose-950/50 to-pink-950/50 border-t border-slate-800">
        <div className="container mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">Join 50+ Indira Nagar businesses who chose Web Nova Crew</p>
