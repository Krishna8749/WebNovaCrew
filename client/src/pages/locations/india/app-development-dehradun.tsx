...
export default function AppDevelopmentDehradun() {
  ...
  return (
    <div className="min-h-screen bg-violet-950 font-sans">
      <SEO title="App Development Company in Dehradun | Mobile App Developers Uttarakhand | XcFlown" description="Top app development company in Dehradun. Android, iOS, Flutter apps for tourism, education. ₹25,000 onwards." keywords="app development Dehradun, mobile app developers Uttarakhand, tourism app Dehradun" />
      <LocalBusinessSchema /><BreadcrumbSchema items={[{ name: "Home", url: "https://xcflown.com" }, { name: "Locations", url: "https://xcflown.com/locations" }, { name: "Dehradun", url: "https://xcflown.com/locations/app-development-dehradun" }]} />
      <ServiceSchema serviceName="App Development in Dehradun" serviceDescription="Professional mobile app development for Dehradun businesses." serviceUrl="https://xcflown.com/locations/app-development-dehradun" />
      <Navbar />
