...
export default function AppDevelopmentChennai() {
  ...
  return (
    <div className="min-h-screen bg-violet-950 font-sans">
      <SEO 
        title="App Development Company in Chennai | Mobile App Developers OMR | XcFlown"
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Chennai", url: "https://xcflown.com/locations/app-development-chennai" }
      ]} />
      <ServiceSchema 
        ...
        serviceUrl="https://xcflown.com/locations/app-development-chennai"
      />
