...
export default function AppDevelopmentNagpur() {
  ...
  return (
    <div className="min-h-screen bg-violet-950 font-sans">
      <SEO title="App Development Company in Nagpur | Mobile App Developers Vidarbha | XcFlown" description="Top app development company in Nagpur. Android, iOS, Flutter apps for logistics, businesses in Sitabuldi, Dharampeth. ₹25,000 onwards." keywords="app development Nagpur, mobile app developers Nagpur, Vidarbha app development, logistics app Nagpur" />
      <LocalBusinessSchema /><BreadcrumbSchema items={[{ name: "Home", url: "https://xcflown.com" }, { name: "Locations", url: "https://xcflown.com/locations" }, { name: "Nagpur", url: "https://xcflown.com/locations/app-development-nagpur" }]} />
      <ServiceSchema serviceName="App Development in Nagpur" serviceDescription="Professional mobile app development for Nagpur businesses." serviceUrl="https://xcflown.com/locations/app-development-nagpur" />
      <Navbar />
