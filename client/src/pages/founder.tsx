...
export default function Founder() {
  ...
  const timeline = [
    ...
    {
      year: "2023",
      title: "XcFlown Founded",
      description: "Launched XcFlown with no mentor, no investor, just determination. Started building digital solutions for businesses."
    },
    {
      year: "2023",
  ...
  return (
    <div className="min-h-screen bg-violet-950 font-sans">
      <SEO 
        title="Sateesh Kumar Rawat - Founder & CEO of XcFlown | Young Indian Entrepreneur"
        description="Meet Sateesh Kumar Rawat, 20-year-old founder of XcFlown, Estato, and Ubiduby. From earning ₹20K/month at 15 to building multiple tech companies. Self-made Indian entrepreneur story."
        keywords="Sateesh Kumar Rawat, Founder of XcFlown, CEO XcFlown, Founder of Estato, Ubiduby Founder, Young Indian Entrepreneur Lucknow, Self-made tech founder India, Estato app Lucknow"
      />
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://xcflown.com" },
        { name: "Founder", url: "https://xcflown.com/founder" }
      ]} />
      <PersonSchema 
        name="Sateesh Kumar Rawat"
        jobTitle="Founder & CEO"
        description="Young Indian tech entrepreneur, founder of XcFlown, Estato, and partner at Ubiduby Fashion"
        url="https://xcflown.com/founder"
      />
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl px-4 relative z-10">
          ...
          >
            ...
            <p className="text-2xl md:text-3xl text-violet-400 mb-6 font-semibold">
              Founder & CEO - XcFlown
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <div className="flex items-center gap-2 px-4 py-2 bg-violet-500/10 border border-violet-500/20 rounded-full">
                ...
                <span className="text-sm text-violet-300">Born 2005 • Age 20</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-violet-500/10 border border-violet-500/20 rounded-full">
                <MapPin className="w-4 h-4 text-violet-400" />
                <span className="text-sm text-violet-300">Lucknow, UP, India</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-violet-500/10 border border-violet-500/20 rounded-full">
                <Briefcase className="w-4 h-4 text-violet-400" />
                <span className="text-sm text-violet-300">3 Companies</span>
              </div>
            </div>

            <div className="bg-violet-900/50 border border-violet-700 rounded-2xl p-8 max-w-2xl mx-auto">
              <Quote className="w-8 h-8 text-violet-400 mb-4 mx-auto" />
        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-violet-800/50 border border-violet-700 rounded-2xl p-8"
            >
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed">
                ...
                <p>
                  Only one classmate, <span className="text-violet-400 font-semibold">Simran Sahni</span>, helped him academically—an act that deeply impacted his life and kept him motivated during the toughest times.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p>
                  The COVID-19 lockdown was the turning point. While the world struggled, Sateesh used his time to learn programming and app development. He started earning through international clients, making <span className="text-violet-400 font-semibold">₹20,000/month as a teenager</span> using only a smartphone.
                </p>
                <p>
                ...
                <p>
                  With his first savings and support from his brother <span className="text-violet-400">Vipin</span> (who contributed ₹4,000), he bought a computer setup: HP CPU and Acer 21-inch Monitor. This PC became the birthstone of all future companies.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p>
                  <strong className="text-white">XcFlown (2023):</strong> With no mentor, no investor, no big support system—only determination—Sateesh launched XcFlown. It's now one of Lucknow's rapidly growing digital agencies, serving clients across India and internationally.
                </p>
                <p>
                  <strong className="text-white">Estato (2023):</strong> Seeing his brother <span className="text-violet-400">Bipin Kumar Rawat</span> struggling to find a room for rent in Lucknow, Sateesh realized the market was unorganized. People were still using paper posters on walls. He built Estato, an AI-driven property renting & selling platform dedicated to Lucknow. His middle brother <span className="text-violet-400">Raj Kumar Rawat</span> played an important role in supporting Estato's growth. It now helps thousands of local residents across Musalmanabad, Sapahaiyya, Gauganj Market, Mallawan, Sandila, and nearby areas.
                </p>
                <p>
                  <strong className="text-white">Ubiduby (2025):</strong> In 2025, Sateesh partnered with <span className="text-violet-400">Radhika Gupta</span>, a passionate entrepreneur with work ethic similar to his own. Together they launched Ubiduby – The Unwritten Rules of Style, a premium fashion brand redefining modern style.
                </p>
              </div>
            </motion.div>
          </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-violet-400 text-sm mb-2">{person.role}</p>
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-blue-900/50 to-slate-800/50 border border-violet-700 rounded-2xl p-8 text-center"
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-2">XcFlown</h3>
              <p className="text-violet-300 text-sm mb-4">Founder & CEO</p>
            ...
            >
              ...
              <p className="text-orange-300 text-sm mb-4">Co-Founder</p>
              <p className="text-slate-300 text-sm">
      ...
      <CTASection 
        ...
        subtitle="Let's discuss your project and see how XcFlown can transform your digital presence."
