...
export default function About() {
  ...
  const milestones = [
    { year: "2023", title: "Founded", description: "XcFlown was established in Lucknow, Uttar Pradesh, India" },
  ...
  return (
    <div className="min-h-screen bg-white font-sans pt-20">
      <SEO 
        ...
        description="XcFlown is India's leading web and mobile app development agency based in Lucknow, UP. 25+ expert developers, 50+ projects delivered, 100% client satisfaction. Learn about our team, values, and mission."
        keywords="about xcflown, web development company india, app development agency hardoi, best web developers india, software company uttar pradesh, IT company UP"
      />
      <LocalBusinessSchema />
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://xcflown.com" },
        { name: "About Us", url: "https://xcflown.com/about" }
      ]} />
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="relative">
               <div className="absolute inset-0 bg-orange-200 rounded-3xl transform rotate-3"></div>
               <div className="relative bg-violet-900 text-white p-10 rounded-3xl shadow-xl overflow-hidden">
                  <div className="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 bg-violet-600 rounded-full blur-3xl opacity-50"></div>
                  <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
                    <Target className="text-orange-400" /> Our Mission
                  </h3>
                  ...
                  <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
                    <Sparkles className="text-orange-400" /> Our Vision
                  </h3>
            ...
            <div>
              ...
              <p className="text-slate-600 mb-8">
                In a crowded market of "me-too" agencies, XcFlown stands out through rigor and results. We combine the agility of a startup with the process discipline of an enterprise.
              </p>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    <div className="w-12 h-12 rounded-full bg-violet-100 flex items-center justify-center shrink-0 text-violet-600">
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamValues.map((value, index) => (
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-violet-100 text-violet-600 flex items-center justify-center mx-auto mb-4">
                  {value.icon}
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div
                ...
                className="bg-slate-50 border border-slate-200 rounded-xl p-4 text-center hover:border-violet-500 hover:shadow-md transition-all"
              >
        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-8">
            {milestones.map((milestone, index) => (
              ...
              >
                <div className="w-20 h-20 rounded-full bg-violet-600 text-white flex items-center justify-center font-bold text-lg shrink-0">
                  {milestone.year}
                </div>
                <div className="pt-2">
      ...
      {/* FAQ Section */}
      <FAQSection 
        title="Frequently Asked Questions About XcFlown"
